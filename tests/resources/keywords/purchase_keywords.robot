...
Add Item And Go To Cart
    Wait Until Element Is Visible    xpath=//button[contains(@id,"add-to-cart")]    timeout=5s
    Click Button    xpath=//button[contains(@id,"add-to-cart")]
    Wait Until Element Is Visible    id=shopping_cart_container    timeout=5s
...
Checkout
    ...
    Wait Until All Elements Visible    5    id=first-name    id=last-name    id=postal-code    id=continue
    Insert Personal Data
